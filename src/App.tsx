        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-300">
          ...
          <div className="relative z-10">
            ...
            <Routes>
              ...
              <Route path="/project/malware-prevention" element={<MalwarePreventionPage />} />
            ...
            <footer className="relative text-gray-600 dark:text-gray-300 py-8 mt-24">
              <div className="container mx-auto px-4 text-center">
                ...
                <div className="flex items-center justify-center gap-4 mb-6">
                  {[
                    { icon: Github, href: "https://github.com/bannyhe" },
                    { icon: Linkedin, href: "https://www.linkedin.com/in/banny-mu-he-352820a3/" },
                    { icon: Mail, href: "mailto:bannyhe@umich.edu" },
                    { icon: Instagram, href: "http://instagram.com/bannyhe_001" },
                  ].map(({ icon: Icon, href }) => (
                    <motion.a
                      key={href}
                      href={href}
                ...
                <p className="text-gray-500 dark:text-gray-400">© 2025 Designed by MU HE. All rights reserved.</p>
              </div>
            </footer>
          </div>
          <Toaster />
